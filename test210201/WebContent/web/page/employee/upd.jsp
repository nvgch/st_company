...
<fieldset class="layui-elem-field" style='margin:20px;padding:20px'>
		...
		<div class="layui-field-box">
			...
			<form class="layui-form layui-form-pane" lay-filter='formA'>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="codeDept" required lay-verify="required"  
				...
				<div class="layui-form-item">
					<div class="layui-input-inline">
						...
						<input type="button" value='确定' lay-submit lay-filter="upd"
							class="layui-btn"> 
	...
	formOn('/employee','submit(upd)','text',function(data){
		  //alert(data)
		  alert(data)
		if("1"== data){
